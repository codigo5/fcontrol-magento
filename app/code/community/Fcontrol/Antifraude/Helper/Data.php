 ...
 */
class Fcontrol_Antifraude_Helper_Data extends Mage_Core_Helper_Abstract
{
    const CORE = 'Fcontrol_Core';
    ...
    public function getConfig($key)
    {
        ...
        if (in_array(self::CORE, $modules)) {
            ...
            if ($modules->Fcontrol_Core->active->xmlentities() == 'true') {
                // $path = 'fcontrol/Antifraude/' . $key;
            }
        }
