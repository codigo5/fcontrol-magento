...
if (version_compare(Mage::getVersion(), '1.3.3', '<=')) {
    ...
    class Fcontrol_Antifraude_Block_Adminhtml_Sales_Order_View_Info extends Mage_Adminhtml_Block_Sales_Order_Abstract
    {
        /**
    ...
    class Fcontrol_Antifraude_Block_Adminhtml_Sales_Order_View_Info extends Mage_Adminhtml_Block_Sales_Order_View_Info
    {
        /*
         * @Fcontrol_Antifraude_Block_Adminhtml_Sales_Order_View_Info
         *
