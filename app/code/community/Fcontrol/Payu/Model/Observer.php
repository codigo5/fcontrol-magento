 ...
 */
class Fcontrol_Payu_Model_Observer
{
                ...
                foreach ($quotes as $quote) {
                    ...
                    switch ($api->getState()) {
                        case Mage_Sales_Model_Order::STATE_COMPLETE:
                            $api->status = Fcontrol_Payu_Model_Api::STATUS_ENVIADO;
                            $api->comentario = "Status do pedido atualizado para 'completo' na Loja";
                            break;
                        case Mage_Sales_Model_Order::STATE_CLOSED:
                            $api->status = Fcontrol_Payu_Model_Api::STATUS_CANCELADO;
                            ...
                            switch ($order->getState()) {
                                case Mage_Sales_Model_Order::STATE_NEW:
                                    ...
                                    try {
                                        ...
                                        if (in_array($status, Fcontrol_Payu_Model_Api::$acaoAprovar)) {
                                        ...
                                        if (in_array($status, Fcontrol_Payu_Model_Api::$acaoCancelar)) {
                                            if ($order->canCancel()) {
                                ...
                                case Mage_Sales_Model_Order::STATE_HOLDED:
                                    ...
                                    $api->codigoPedido = $order_id;
                                    $api->status = Fcontrol_Payu_Model_Api::STATUS_SOLICITADA_SUPERVISAO;
