...
class Fcontrol_Payu_Adminhtml_Sales_OrderController extends Mage_Adminhtml_Sales_OrderController
{

    const BLOCK_SALES_ORDER_FRAME = 'Fcontrol_Payu_Block_Adminhtml_Sales_Order_View_Info';
    ...
    public function viewAction()
    {
        ...
        if ($order = $this->_initOrder()) {
            ...
            switch (Mage::helper('fcontrol')->getConfig('type_service')) {
                case Fcontrol_Payu_Model_Api::FRAME:
                    $block = $this->getLayout()->createBlock(
                        self::BLOCK_SALES_ORDER_FRAME,
                        'fcontrol.sales.order.view.info',
                        array(
                            'template' => 'fcontrol/payu/sales/order/view/info.phtml',
                            'before' => '-'
                        )
                    );
                    ...
                    break;
                case Fcontrol_Payu_Model_Api::FILA_LOJISTA_UNICO:
                case Fcontrol_Payu_Model_Api::FILA_LOJISTA_PASSAGENS:
                case Fcontrol_Payu_Model_Api::FILA_VARIOS_LOJISTAS:
                    if ($order->getId()) {
